...
class Training(models.Model):
    ...
    treino = models.ForeignKey(
        Treinos, on_delete=models.CASCADE, null=True, blank=True)
...
class Anamnese(models.Model):
    ...
    frequencia_atividades = models.CharField(
        max_length=300, null=True, blank=True)
    ...
    historico_cardiaco = models.CharField(
...
class Antropometria(models.Model):
    ...
    massa_corporal = models.CharField(max_length=200, null=True, blank=True)
    estatura = models.CharField(max_length=200, null=True, blank=True)
    pescoco = models.CharField(max_length=200, null=True, blank=True)
    ombro = models.CharField(max_length=200, null=True, blank=True)
    torax = models.CharField(max_length=200, null=True, blank=True)
    cintura = models.CharField(max_length=200, null=True, blank=True)
    abdome = models.CharField(max_length=200, null=True, blank=True)
    quadril = models.CharField(max_length=200, null=True, blank=True)

    # Perimetria direita
    braco_direito = models.CharField(max_length=200, null=True, blank=True)
    ante_braco_direito = models.CharField(
        max_length=200, null=True, blank=True)
    coxa_direito = models.CharField(max_length=200, null=True, blank=True)
    panturrilha_direito = models.CharField(
        max_length=200, null=True, blank=True)

    # Perimetria esquerda
    braco_esquerda = models.CharField(max_length=200, null=True, blank=True)
    ante_braco_esquerda = models.CharField(
        max_length=200, null=True, blank=True)
    coxa_esquerda = models.CharField(max_length=200, null=True, blank=True)
    panturrilha_esquerda = models.CharField(
        max_length=200, null=True, blank=True)

    imc = models.CharField(max_length=200, null=True, blank=True)
    gordura = models.CharField(max_length=200, null=True, blank=True)
    massa_corporal_2 = models.CharField(max_length=200, null=True, blank=True)
    metabolismo = models.CharField(max_length=200, null=True, blank=True)
    idade_corporal = models.CharField(max_length=200, null=True, blank=True)
    gordura_viceral = models.CharField(max_length=200, null=True, blank=True)

    avaliado = models.CharField(
        max_length=50, choices=AVALIADO, default='ativo')
...
class Profile(models.Model):
    ...
    profile_img = ResizedImageField(
        size=[600, 600], quality=85, upload_to='academia/users/', default='academia/users/default-user.jpg')
